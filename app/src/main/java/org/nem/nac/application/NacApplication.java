...
//		formUri = "http://blevx.com:5984/acra-myapp/_design/acra-storage/_update/report",
//		formUriBasicAuthLogin = "nemreport",
//		formUriBasicAuthPassword = "hbo123456",
        formUri = "http://blevx.com:5984/acra-xmnotes/_design/acra-storage/_update/report",
        formUriBasicAuthLogin = "xmnotes",
        formUriBasicAuthPassword = "qvod7370",
...
public final class NacApplication extends Application {
    ...
    public static void mockContextForTestPurposes(Context contextMock) {
        _appContext = contextMock;
    }
}
