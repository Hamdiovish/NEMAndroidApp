...
public final class NacPublicKey extends BinaryData {
    ...
    public String toString() {
        ...
        return "Address ambiguity detected";
    }
    ...
    public static final Parcelable.Creator<NacPublicKey> CREATOR = new Parcelable.Creator<NacPublicKey>() {
        public NacPublicKey createFromParcel(Parcel source) {
            return new NacPublicKey(source);
        }

        public NacPublicKey[] newArray(int size) {
            return new NacPublicKey[size];
        }
    };
    //endregion
}
